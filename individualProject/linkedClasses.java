...
public class linkedClasses {
    ...
    public static void insertStudentsToCourse(List<Course> courseList, List<Student> studentList) {
        /*
...
//                        studentList.get(indexOfCourse - 1).getAssignmentListOfStudent().get(currentAssignment).setTotalMark(mark);
    ...
    public static void insertTrainerToCourse(List<Course> courseList, List<Trainer> trainerList) {
        int i = 1;
        int j = 1;
        Scanner sc = new Scanner(System.in);
        int indexOfTrainer;
...
//                    }
    ...
    public static void insertAssignmentToCourse(List<Course> courseList, List<Assignment> assignmentList) {
        int i = 1;
        int j = 1;
        Scanner sc = new Scanner(System.in);

...
//    }
        ...
        ResultSet resultSet = db.getResultSet("Select * from trainers");
        try {
            while (resultSet.next()) {
...
//                }
        ...
        ResultSet resultSet = db.getResultSet("Select * from assignments");
        try {
            while (resultSet.next()) {
...
//                }
        ...
        ResultSet resultSet = db.getResultSet("Select * from Courses");
        try {
            while (resultSet.next()) {
    ...
    public static void printAllStudentsPerCourses(Database db) {
...
//                }
        ...
        ResultSet resultSet = db.getResultSet("select courses.title,students.id,firstName,lastName,dateOfBirth,tuitionFees from `students`"
    ...
    public static void printAllTrainersPerCourse(Database db) {
...
//        }
    ...
    public static void printAllAssignmentsPerCourse(Database db) {
...
//        }
    ...
    public static void printAllAssignmentsPerStudent(Database db) {
...
//        }
        ...
        ResultSet resultSet = db.getResultSet("SELECT students.firstName,students.lastName,courses.title, student_courses_assginments.assignment_title,student_courses_assginments.totalMark \n"
                + "fROM individualprojectpartb.student_courses_assginments\n"
                + "join students on students.id=student_courses_assginments.student_id\n"
                + "join courses on courses.id=student_courses_assginments.course_id\n"
